...
(function(window, document, $, undefined){
  ...
  $(function(){
      var change_image = function() {
        ...
        var $name = ['Basudev Poudel','Usman Khan','Shubham Kaphle','Rambaran Yadav']
        $(".user-block-picture > .user-block-status img").attr("src","img/user/"+$imgs[$rand]);
        $(".user-block-info > .user-block-name").html($name[$rand])
        document.title = $name[$rand] + " - Control Panel - "+$rand;
      }
